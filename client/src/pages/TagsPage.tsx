...
const TagsPage: React.FC<TagsPageProps> = ({ isAuthenticated }) => {
  ...
  const fetchTags = async () => {
    try {
      ...
      setError("Tags could not be loaded. Please try again later.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleAddTags = async () => {
    ...
    try {
      ...
      setError("Tags could not be created. Please try again.");
    } finally {
  ...
  const handleDelete = async (tag: Tag) => {
    ...
    try {
      ...
      setError("Tag could not be deleted. Please try again.");
    } finally {
      setLoading(false);
    }
  };
                  ...
                  <TableCell>
                    {isAuthenticated ? (
                      <Tooltip
                        content={
                          tag.postCount
                            ? "Cannot be deleted because posts are still associated"
                            : "Delete tag"
                        }
                      >
                        <Button
